...
class ProductStockSourceTests(TestCase):
    ...
    def test_product_reconciliation_screen_is_read_only_filterable_and_linked(self):
        content = build_xlsx('product_sth', PRODUCT_HEADERS, [[
