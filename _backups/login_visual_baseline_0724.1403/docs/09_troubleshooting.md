...
## LOGIN-TROUBLESHOOTING-0724.1358

Do not replace the generic login error with profile-specific text. To diagnose a rejected existing account, inspect Docker logs and the Calculator User Profile in Django Admin. Browser responses must not reveal whether the username, password or profile was valid.
