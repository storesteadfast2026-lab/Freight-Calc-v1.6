...
**Implemented:** 2026-07-24 13:26 Australia/Melbourne  
**Status:** Code prepared; Docker verification required.
...
config/urls.py (targeted installer update)
config/settings/base.py (targeted installer update)
```
