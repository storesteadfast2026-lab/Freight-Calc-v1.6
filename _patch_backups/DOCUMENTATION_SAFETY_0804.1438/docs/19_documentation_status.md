...
- Docker/browser visual confirmation remains required after installation.
...
- Focused Fuel import tests and affected regressions are executed by the installer.
