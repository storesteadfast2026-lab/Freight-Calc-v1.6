...
class FreightRate(models.Model):
    ...
    basic_charge = models.DecimalField(max_digits=12, decimal_places=4, default=Decimal('0'))
    per_subsequent_basic = models.DecimalField(max_digits=12, decimal_places=4, default=Decimal('0'))
    per_kg = models.DecimalField(max_digits=12, decimal_places=4, default=Decimal('0'))
    overweight_charge = models.DecimalField(max_digits=12, decimal_places=4, default=Decimal('0'))
    remote_charge = models.DecimalField(max_digits=12, decimal_places=4, default=Decimal('0'))
    offshore_charge = models.DecimalField(max_digits=12, decimal_places=4, default=Decimal('0'))
    overlength_charge = models.DecimalField(max_digits=12, decimal_places=4, default=Decimal('0'))
