...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # English: data_only=True reads the values cached by Excel, including fuel levy formulas.
        # Español: data_only=True lee valores calculados guardados por Excel, incluyendo fuel levy.
    ...
    def replace_client_data(self, client):
        ...
        ExternalDataFile.objects.filter(client=client).delete()
